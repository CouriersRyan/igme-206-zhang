/*
 * Ryan Zhang
 * PE - Abstraction & Polymorphism
 * https://docs.google.com/document/d/13fKKOou-UcTouh4x6gcAGgvzM3hnZoT2woVoWdLCPUE/edit?usp=sharing
 */
...
namespace Abstraction_Polymorphism_Demo
{
    class Program
    {
        ...
        private static void ShapesDemo()
        {
            ...
            // ~~~~~~~~~~~~~ NEW CODE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            // Demo of new shapes Triangle and Trapezoid.
            Shape tri = new Triangle(4, 10);
            Console.WriteLine(tri);

            Shape trap = new Trapezoid(6, 8, 4);
            ...
            do
            {
                choice = GetPromptedInput("What type of shape do you want" +
                    "(circle, square, triangle, trapezoid, or Q to quit)?").ToUpper();
                switch (choice)
                {
                    ...
                    // ~~~~~~~~~~~~~ NEW CODE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                    // Get the base and width for a new triangle and add it to the list
                    case "TRIANGLE":
                        shapes.Add(new Triangle(GetPromptedPositiveDouble("What is the base length?"),
                            GetPromptedPositiveDouble("What is the height?")));
                        break;

                    // Get the 2 bases and width for a new trapezoid and add it to the list
                    case "TRAPEZOID":
                        shapes.Add(new Trapezoid(GetPromptedPositiveDouble("What is the first base length?"),
                            GetPromptedPositiveDouble("What is the second base length?"),
                            GetPromptedPositiveDouble("What is the height?")));
                        break;
        ...
        private static void PetsDemo()
        {
            ...
            for (int i = 0; i < pets.Length; i++)
            {
                ...
                {
                    pets[i] = new Frog(names[i], DateTime.Today);
                }
                else if (i % 5 == 3)
                {
